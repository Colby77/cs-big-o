...
// ANSWER:
the length of the array of numbers or O(n)
...
// The time complexity is just O(1). It's just slightly faster than the other solution but not enough to
...
// countLetters' space complexity is dependent on n where n represents the actual letters in the given string and
// countLettersRoundTwo's is also dependent on n for the same reason. They each count the letters of the given string.